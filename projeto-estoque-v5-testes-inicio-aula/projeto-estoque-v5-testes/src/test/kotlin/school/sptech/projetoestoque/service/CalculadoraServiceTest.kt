...
O 2o valor: valor do teste
         */
        assertEquals(5.75, resultado, 0.001)

        val resultado2 = service.calcularPrecoVenda(10.00)
        assertEquals(11.50, resultado2, 0.001)
    }
    ...
    fun `O valor de venda dever ser o valor de compra +10%`() {
        ...
        assertEquals(110.00, resultado2, 0.001)
    }
...
//    @ParameterizedTest
 ...
 /*@CsvSource(value =
    ...
    fun precoVendaCompraNegativo(){
        val vendaNegativa1 = -0.01
        val vendaNegativa2 = -100.0

        assertThrows(IllegalArgumentException::class.java)
            {service.calcularPrecoVenda(vendaNegativa1)}

        val excecao = assertThrows(IllegalArgumentException::class.java)
            {service.calcularPrecoVenda(vendaNegativa2)}

        assertEquals(
            "Peço de venda deve ser >= 0. Usado $vendaNegativa2", excecao.message)
        }
